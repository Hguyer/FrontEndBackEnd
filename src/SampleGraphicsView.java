...
public class SampleGraphicsView extends JFrame {

    public static final int WINDOW_WIDTH = 1000;
    public static final int WINDOW_HEIGHT = 1000;

    public SampleGraphicsView(String title) {

        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);// Tells the program what to do when the window is closed.
        this.setTitle(title);		                        // Sets the title of the window.
    ...
    //  You need a paint() method with one Graphics parameter. This tells the computer
